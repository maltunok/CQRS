...
{
    public class GetStudentByAgeHandler : IHandlerWrapper<GetStudentsByAgeQuery, ICollection<StudentDto>>
    {
        private readonly SchoolContext _schoolContext;

        public GetStudentByAgeHandler(SchoolContext schoolContext)
        {
